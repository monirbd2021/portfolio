                ...
                <div class="row align-items-center">
                    <div class="col-sm-12 col-md-6">
                        <div class="hero-content">
                            <div class="hero-text">
                                ...
                                <h1>Monir Sharkar</h1>
                                <h2></h2>
                                <div class="typed-text">Web Designer, Web Developer, Front End Developer</div>
                            </div>
                            <div class="hero-btn">
                    ...
                    <div class="col-sm-12 col-md-6 d-none d-md-block">
                        <div class="hero-image">
                            <img height="510px" src="img/monir_hero.png" alt="Hero Image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="about wow fadeInUp" data-wow-delay="0.1s" id="about">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="img/monir_about.jpg" alt="Image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <div class="about-text">
                                <p>
                                    I am a web Designer and Developer. I am already worked on five and more project.
                                </p>
                            </div>
                            ...
                            <div class="skills">
                                ...
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="1"></div>
                                </div>
                                <div class="skill-name">
